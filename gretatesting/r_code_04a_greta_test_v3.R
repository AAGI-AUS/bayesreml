# source("r_code_04a_greta_test_v3.R")
...
#for (i1 in 2:3) {
	...
	beta_loc <- normal(0, 100, dim = n_loc)
	beta_yearf <- normal(0, 100, dim = n_yearf)
	beta_env <- normal(0, 100, dim = n_env)
	...
	mu <- beta_loc[data_work$loc_numeric] +
